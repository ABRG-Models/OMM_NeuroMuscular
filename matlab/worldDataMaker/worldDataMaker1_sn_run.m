function [R, F, T, Sd1, S, GPe, GPi, SCd, SCs] = worldDataMaker1_sn_run (L)  %   
...
while escaped == false
    ...
    if qrtn(1,2) == 1
        ...
        F   = spinemlnetGetData (context, 'FEF');
        T   = spinemlnetGetData (context, 'Thalamus');
        Sd1 = spinemlnetGetData (context, 'StrD1');
        S   = spinemlnetGetData (context, 'STN');
