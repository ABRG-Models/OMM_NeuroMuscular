...
POPULATIONS=('Retina_1' 'Retina_2' 'FEF' 'SC_deep' 'GPe' 'SC_avg' 'SNr' 'STN' 'Str_D1' 'Thalamus' 'FEF_add_noise' 'World')
...
echo "split..."
if [ ! -f "$LOGDIR${POPULATIONS[0]}"_out_uint8.bin ]; then
    echo "No file $LOGDIR${POPULATIONS[0]}"_out_uint8.bin". Run convertLogs."
    exit 1
fi
