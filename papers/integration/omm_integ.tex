...
Fig.~\ref{brain_model} shows a schematic of the SpineML implementation
...
(b). Fig.~\ref{brain_model} expands the `SC', `BG' and `slow retinal'
...
`World' and is the retinotopic projection [Fig.~\ref{brain_model}(b)]
of the eye's field of view of the world [Fig.~\ref{brain_model}(a)]
...
Fig.~\ref{fig:mapping}. Fig.~\ref{weightmaps}(a) shows the weight map
...
weight map is 0. Fig.~\ref{weightmaps}(d) shows the weight map for
...
map is a mirror of Fig.~\ref{weightmaps}(a), reflected about the line
...
versa. Fig~\ref{weightmaps}(b) \& (d) show the weight maps for
