...
muscles. b) OpenSim rendering of biomechanical eye within a head
model c) Top-down schematic cross-sectional view of the biomechanical eye situated
within a spherical screen, with a horizontal rotation towards a
luminances at an angle of $-\theta_{y}$ about the $y$ axis, which
