...
by excitatory input.} At this point, the naming scheme for the
...
system imitating the behaviour of the rat's sensory processing systems
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:ccg_model} Figure \arabic{figure}.}
{ \bol{a) The macroscopic architecture of the \ccg~model.} The main
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:brainmodel} Figure \arabic{figure}.}
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:bioeye} Figure \arabic{figure}.}
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:modelframework} Figure \arabic{figure}.}
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:saccvstarg} Figure \arabic{figure}.}
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:errorsurfaceTM3} Figure \arabic{figure}.}
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:latvsall} Figure \arabic{figure}.}
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:doublesteps} Figure \arabic{figure}.}
