...
engines can be utilised, including DAMSON (\mycite{richmond_damson_2015}), GeNN
...
applied in \stob~(\mycite{cope_spineml_2_brahms_2015}) making use of a \stob~feature designed for this purpose (The external.xsl file).

%\footnote{See the \branch{NoTremor\_Oculomotor\_201603} branch of \url{https://github.com/SpineML/SpineML\_2\_BRAHMS/}}.
...
the superior colliculus~(\mycite{robinson_eye_1972}). % FIXME: and frontal eye field?
...
%
% The importance of an even sized hill of activity in SC_deep. The difficulties of achieving this.
...
technical and scientific integration of the biomechanical eye.
DS, CP and KM developed the biomechanical eye model. SJ wrote the 
manuscript. KG conceived the experiment. % FIXME: This needs correcting/developing.
...
{ \textbf{fig:intro\_graphic} An isolated brain model. Crafted inputs are introduced into one of
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[width=0.45\textwidth]{./figures/lat_vs_dopamine.png}
\end{center}
\textbf{\refstepcounter{figure}\label{fig:lat_vs_dop} Figure \arabic{figure}.}
{ \textbf{fig:lat\_vs\_dop} Latency vs.~dopamine.}
\end{figure}

\begin{figure}[htb!]
\begin{center}
\includegraphics[width=0.45\textwidth]{./figures/sacc_vs_lum.png}
\end{center}
\textbf{\refstepcounter{figure}\label{fig:lat_vs_lum} Figure \arabic{figure}.}
