...
\rvw{\cite{pearson_whiskerbot:_2007} describes a wheeled robot which has a
...
non-biologically accurate wheel motor control algorithm to achieve
...
computational neurobehavioural studies.}
...
which is able to determine the distance between the robot and an
obstacle and the obstacle's height. The authors demonstrate that the
virtual robot is able to learn to climb obstacles in a realistic
manner and suggest that the model may be compared with experimental
...
\end{center}
\caption{ The biomechanical eye. a) an OpenSim rendering of a pair of
...
\end{center}
\caption{ a) \& b) Tabareau-style weight maps for `left' and `down' components
...
\end{center}
\caption{ Accuracy at different target eccentricities for fixation luminance
...
\end{center}
\caption{ Representative single saccades. a) Trajectories from 9 saccades to a
...
\end{center}
\caption{ Exploring saccade latencies. a) Latency to first movement as a
