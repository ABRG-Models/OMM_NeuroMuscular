...
initiation of an eye movement matched experimental data, while also
matching the electrophysiological evidence of activity in a variety of
brain regions. The tuning of the BG model attempted to preserve as
closely as possible the weights used in the original paper. Further
details on the parameterisation of the \ccg~model are
in \cite{cope_basal_2017}.}
...
Figure \ref{fig:eye_muscles}, while Figure \ref{fig:eye_head} depicts
the head model used in the proposed framework.}

% To be moved in due course
\begin{figure}[htb!]
\begin{center}
\includegraphics[width=0.5\textwidth]{./figures/bio_eye1.png}
\end{center}
\textbf{\refstepcounter{figure}\label{fig:eye_muscles} Figure \arabic{figure}.}
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:eye_head} Figure \arabic{figure}.}
...
% KM
\rvwt{Figure \ref{fig:eye_sim0} illustrates an example of the experimental
set-up of the proposed framework, while Figures \ref{fig:eye_sim1}
and \ref{fig:eye_sim2} depict the developed eye oculomotor simulation
system.}

% Figures to merge together into a single panel or move.
\begin{figure}[htb!]
\begin{center}
\includegraphics[width=0.5\textwidth]{./figures/Eye_sim0.png}
\end{center}
\textbf{\refstepcounter{figure}\label{fig:eye_sim0} Figure \arabic{figure}.}
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:eye_sim1} Figure \arabic{figure}.}
...
\end{center}
\textbf{\refstepcounter{figure}\label{fig:eye_sim2} Figure \arabic{figure}.}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[width=0.9\textwidth]{./figures/ccg_model.png}
\end{center}
