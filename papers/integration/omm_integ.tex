...
to the brain model.  This is shown in Fig.~\ref{fig:sbg}, which indicates
...
Fig.~\ref{mapping}). Closer to the fovea, the \rvwt{effect of} the
...
\rvw{Modern programming platforms, often originating from the world
of computer gaming, make it relatively easy to model a virtual
...
\rvw{\bol{FIXME}. We should consider whether inaccuracies within one sub-system,
such as the musculo-skeletal model, may introduce errors that
propagate through the closed loop system and cannot be counteracted by
the nervous system part of the simulation.  My thoughts: You have to
do this alongside other research so that sub-systems are informed by
the best knowledge available.
%
How can you (or someone using this or related models)
exclude introducing (biomechanical) properties that are not present in
the biological system, or make sure to not miss critical biomechanical
properties that might help remedy some of the shortcomings of the
closed loop model?.}
