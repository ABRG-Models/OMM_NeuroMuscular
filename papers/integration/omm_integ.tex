...
% KM
An illustration of the biomechanical eye model is given in
...
% KM
Two types of muscle models of different complexity are supported. The
...
[Thelen_ref.ris] that is also supported by OpenSim and implements
...
% KM
Finally, numerical integration of the biomechanical eye model is based
on the Kutta-Merson integration method.

% KM
Figure \ref{fig:eye_sim0} illustrates an example of the experimental
