...
%% level.
%%
%% This is developed from perform_saccade.m
%%
...
%%   gap_ms, lum, dop)
%%
function perform_sacc_scsum (resultdir, targetThetaX, targetThetaY, num_par_runs, gap_ms, lum, dop)
    ...
    [ eyeRAvg, eyeRSD, eyeRFinals, peakPos, startMove, scsum_ar ] = run_simulation_multi_scsum (model_dir, output_dirs, params)
    ...
    scsumname = [resdatname '_scsum'];
    result.(scsumname) = scsum_ar;
