...
%%   gap_ms, lum, dop)
%%
function perform_sacc_llbn (resultdir, targetThetaX, targetThetaY, num_par_runs, gap_ms, lum, dop)
    ...
    [ eyeRAvg, eyeRSD, eyeRFinals, peakPos, startMove,llbn_ar ] = run_simulation_multi_llbn (model_dir, output_dirs, params)
    ...
    llbnname = [resdatname '_llbn'];
    result.(llbnname) = llbn_ar;
