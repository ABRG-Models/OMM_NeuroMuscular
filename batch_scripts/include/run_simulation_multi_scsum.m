function [ eyeposAvg, eyeposSD, eyeposFinals, peakPos, startMove, scsum_ar ] = run_simulation_multi_scsum (model_dir, output_dirs, params)
%% Like run_simulation_multi, but ALSO return SCSUM data. HOW?
...
%% seb-specific code.
    ...
    for i = 1:params.num_runs
        ...
        % Record scsum data.
        [scsum, _count] = load_sc_data ([output_dirs.root '_' num2str(i) '/log/SC_sum_a_log.bin'], 1);
        display(['Loaded ' num2str(_count) ' data points from SC_sum_a_log.bin.']);
        scsum_ar = [scsum_ar; scsum];
